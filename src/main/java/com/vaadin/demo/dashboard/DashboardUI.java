...
public class DashboardUI extends UI {
	...
	private static final long serialVersionUID = -11688598946897019L;
    ...
    private void buildLoginView(boolean exit) {
        ...
        HelpOverlay w = helpManager
                .addOverlay(
                        ...
                        "<p>This application is not real, it only demonstrates an application built with the "
                        + "<a href=\"http://vaadin.com\">Vaadin framework</a>.</p><p>No username or password is required, "
                        + "just click the ‘Sign In’ button to continue. You can try out a random username and password, though.</p>",
                        "login");
        w.center();
        addWindow(w);
    ...
    private void buildMainView() {
        ...
        String[] views = new String[] { 
        		"dashboard", "sales", "transactions", "reports", "schedule" 
        		};
