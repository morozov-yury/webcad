...
import diploma.webcad.view.components.SigninCredentialsBean;

@SuppressWarnings("serial")
@org.springframework.stereotype.Component
@Scope("prototype")
public class SignInUpTile  extends AbstractSignInTile {
	...
	private Component generateNotSignedView() {
		...
		SigninCredentialsBean signinCredentialsBean = new SigninCredentialsBean();
		final Item item = new BeanItem<SigninCredentialsBean>(signinCredentialsBean);
