...
@Entity
@Table(name = "triggerJobInfo_Contest_End_Request_Accepting")
public class ContestEndRequestAcceptingInfo  extends TriggerJobInfo implements Serializable {
	
	private static final long serialVersionUID = 17653651987239202L;
	
	private Boolean contestAware20perc;
	private Boolean contestAware10perc;
	private Boolean contestAware5perc;

	public ContestEndRequestAcceptingInfo() {
