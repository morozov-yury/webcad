...
@Entity
@Table(name = "triggerJobInfo_Contest_End_Work_Accepting")
public class ContestEndWorkAcceptingInfo  extends TriggerJobInfo implements Serializable {
	...
	public ContestEndWorkAcceptingInfo() {
